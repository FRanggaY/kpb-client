                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                <form className="pt-10 px-6 pb-4 space-y-6 lg:px-8 sm:pb-6 xl:pb-8" action="#">
                                    <h3 className="text-xl text-center font-medium text-gray-900 dark:text-white">Ubah Data</h3>
                                ...
                                <div class="grid xl:grid-cols-2 xl:gap-6">
                                    <div class="relative z-0 mb-6 w-full group">
                                        <label for="Name" className="block mb-2 text-left text-sm font-medium text-gray-900 dark:text-gray-300">NIP</label>
                                ...
                                <div class="grid xl:grid-cols-2 xl:gap-6">
                                    <div class="relative z-0 mb-6 w-full group">
                                        <label for="Name" className="block mb-2 text-left text-sm font-medium text-gray-900 dark:text-gray-300">NIK</label>
