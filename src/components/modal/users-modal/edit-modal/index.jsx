                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                <form className="pt-10 px-6 pb-4 space-y-6 lg:px-8 sm:pb-6 xl:pb-8" action="#">
                                    <h3 className="text-xl text-center font-medium text-gray-900 dark:text-white">Ubah User</h3>
                                ...
                                <div class="relative z-0 mb-6 w-full group">
                                    <label for="Name" className="block mb-2 text-left text-sm font-medium text-gray-900 dark:text-gray-300">Nama</label>
                                        <input type="Text" name="name" id="name" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Nama" required />
                                </div>
                                <div class="relative z-0 mb-6 w-full group">
                                    <label for="Name" className="block mb-2 text-left text-sm font-medium text-gray-900 dark:text-gray-300">Password</label>
                                        <input type="password" name="password" id="password" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Password" required />
                                </div>
                                <div class="grid xl:grid-cols-2 xl:gap-6">
                                    <div class="relative z-0 mb-6 w-full group">
                                        <label for="Name" className="block mb-2 text-left text-sm font-medium text-gray-900 dark:text-gray-300">Status</label>
                                        <input type="Text" name="status" id="status" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="status" required />
                                    </div>
                                    <div class="relative z-0 mb-6 w-full group">
                                        <label for="Name" className="block mb-2 text-left text-sm font-medium text-gray-900 dark:text-gray-300">Role</label>
