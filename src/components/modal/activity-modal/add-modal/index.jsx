    ...
    render() {
        return (
            <Fragment>
                ...
                <div class="hidden overflow-y-auto overflow-x-hidden fixed right-0 left-0 top-8 z-50 justify-center items-center md:inset-0 h-modal sm:h-full" id="large-modal">
                    <div class="relative px-4 w-full max-w-4xl h-full">
                        {/* <!-- Modal content --> */}
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                <form className="pt-10 px-6 pb-4 space-y-6 lg:px-8 sm:pb-6 xl:pb-8" action="#">
                                    <h3 className="text-xl font-medium text-gray-900 dark:text-white">Tambah Kegiatan</h3>
                                ...
                                <div class="relative z-0 mb-6 w-full group">
                                    <label for="Name" className="block mb-2 text-left text-sm font-medium text-gray-900 dark:text-gray-300">Time</label>
                                        <input type="Text" name="time" id="time" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Time" required />
                                </div>
                                <div class="relative z-0 mb-6 w-full group">
