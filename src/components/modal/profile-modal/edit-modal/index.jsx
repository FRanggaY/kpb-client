                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                <form className="pt-10 px-6 pb-4 space-y-6 lg:px-8 sm:pb-6 xl:pb-8" action="#">
                                    <h3 className="text-xl font-medium text-gray-900 text-center dark:text-white">Ubah Profile</h3>
                                   ...
                                   <div class="relative z-0 mb-6 w-full group">
                                    ...
                                    <div class="relative z-0 mb-6 w-full group">
                                        <label for="Name" className="block mb-2 text-left text-sm font-medium text-gray-900 dark:text-gray-300">Unit Kerja</label>
                                    ...
                                    <div className="relative z-0 mb-6 w-full group">
                                        <label for="message" class="block mb-2 text-sm text-left font-medium text-gray-900 dark:text-gray-400">Deskripsi</label>
                            ...
                            <div className="flex items-center p-6 space-x-2 rounded-b border-t border-gray-200 dark:border-gray-600">
                                <button data-modal-toggle="large-modal" type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Ubah</button>
                                {/* <button data-modal-toggle="large-modal" type="button" className="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:ring-gray-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600">Batal</button> */}
                            </div>
                        </div>
                    </div>
                </div>
