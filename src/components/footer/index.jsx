                ...
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <a href="https://flowbite.com" target="_blank" className="flex items-center">
                            <img src="/docs/images/logo.svg" className="mr-4 h-10" alt="FlowBite Logo" />
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            ...
                            <ul>
                                <li className="mb-4">
                                    <a href="https://flowbite.com" target="_blank" className="text-gray-600 hover:underline dark:text-gray-400">Flowbite</a>
                                </li>
                                <li>
                        ...
                        <div>
                            ...
                            <ul>
                                <li className="mb-4">
                                    <a href="https://github.com/themesberg/flowbite" target="_blank" className="text-gray-600 hover:underline dark:text-gray-400">Github</a>
                                </li>
                                <li>
                                    <a href="https://discord.gg/4eeurUVvTy" target="_blank" className="text-gray-600 hover:underline dark:text-gray-400">Discord</a>
                                </li>
                            </ul>
                        </div>
                        <div>
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="#" target="_blank" className="text-gray-600 hover:underline dark:text-gray-400">Terms &amp; Conditions</a>
                                </li>
                            </ul>
                        </div>
                    </div>
