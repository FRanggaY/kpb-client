...
export default function CardProfile({ color }) {
  return (
    <>
      <div
        className={
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                  ...
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellat, consequatur voluptas iste qui cumque quasi vel? Quia eaque vero deleniti voluptate non omnis fuga soluta aut. Tempora harum deserunt magnam?
                </td>
                <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                  <i className="fas fa-circle text-teal-500 mr-2"></i>
                  img.jpg
